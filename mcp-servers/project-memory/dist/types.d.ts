...
export type DocumentType = 'master-index' | 'project-overview' | 'project-architecture' | 'data-dictionary' | 'expert-log' | 'biz-policy' | 'process' | 'system-index' | 'urs' | 'modspec' | 'architecture' | 'data-model' | 'test' | 'user-guide' | 'admin-guide' | 'service-spec' | 'deploy-ops' | 'verify' | 'key-facts' | 'changelog' | 'checkpoint' | 'custom';
