...
export declare const VALID_PREFIXES: readonly ["PROB", "PAIN", "BG", "PG", "BR", "UJ", "TERM", "ENT", "ENUM", "US", "UC", "AC", "AP", "ADR", "FT", "API", "UI", "TBL", "INT", "NFR", "TC", "TP", "UAT", "CHG", "EVOL", "PIN", "PERIPH", "TASK", "SM", "MSG", "RISK", "MC"];
