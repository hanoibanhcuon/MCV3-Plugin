 ...
 */
async function mcLoad(params, projectRoot) {
    // ── Validate ──────────────────────────────────────────────────────────
    ...
    if (params.layer === 0) {
        ...
        if (!params.filePath.includes('key-facts')) {
            ...
            if (await (0, file_io_js_1.exists)(path.join(projectPath, keyFactsPath))) {
...
//# sourceMappingURL=mc-load.js.map